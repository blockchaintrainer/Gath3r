...
By default, gthpcoind will dump mempool on shutdown and
...
class MempoolPersistTest(GthpcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gthpcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
