...
"""Verify that starting gthpcoin with -h works as expected."""

from test_framework.test_framework import GthpcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(GthpcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gthpcoin with -h for help text")
        ...
        self.log.info("Start gthpcoin with -version for version information")
        ...
        self.log.info("Start gthpcoind with -fakearg to make sure it does not start")
