...
#ifndef GTHPCOIN_INTERFACES_NODE_H
#define GTHPCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a gthpcoin node (gthpcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GTHPCOIN_INTERFACES_NODE_H
