...
#ifndef GTHPCOIN_COMPAT_ASSUMPTIONS_H
#define GTHPCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Gthpcoin cannot be compiled without assertions."
#endif
...
#endif // GTHPCOIN_COMPAT_ASSUMPTIONS_H
