...
#ifndef GTHPCOIN_SCRIPT_STANDARD_H
#define GTHPCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a gthpcoin address
 */
...
/**
 * Generate a Gthpcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GTHPCOIN_SCRIPT_STANDARD_H
