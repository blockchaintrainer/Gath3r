    ...
    platformStyle(_platformStyle)
{
    ...
    // normal gthpcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying gthpcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &GthpcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
