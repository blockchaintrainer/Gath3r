    ...
    mapper(nullptr)
{
    ...
    ui->gthpcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->gthpcoinAtStartup);
    ...
    ui->gthpcoinAtStartup->setToolTip(ui->gthpcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->gthpcoinAtStartup->setText(ui->gthpcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openGthpcoinConfButton->setToolTip(ui->openGthpcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new GthpcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gthpcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGthpcoinConfButton_clicked()
{
