...
#ifndef GTHPCOIN_QT_SPLASHSCREEN_H
#define GTHPCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Gthpcoin Core initialization
...
#endif // GTHPCOIN_QT_SPLASHSCREEN_H
