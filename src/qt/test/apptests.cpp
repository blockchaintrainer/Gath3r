...
//! Entry point for GthpcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GthpcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GthpcoinGUI tests.
void AppTests::guiTests(GthpcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GthpcoinGUI::consoleShown, this, &AppTests::consoleTests);
