...
#ifndef GTHPCOIN_QT_GTHPCOINUNITS_H
#define GTHPCOIN_QT_GTHPCOINUNITS_H
...
/** Gthpcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GthpcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GthpcoinUnits(QObject *parent);

    /** Gthpcoin units.
      @note Source: https://en.gthpcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef GthpcoinUnits::Unit GthpcoinUnit;

#endif // GTHPCOIN_QT_GTHPCOINUNITS_H
