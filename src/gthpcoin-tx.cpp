...
static void SetupGthpcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " gthpcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  gthpcoin-tx [options] <hex-tx> [commands]  Update hex-encoded gthpcoin transaction\n" +
            "or:     gthpcoin-tx [options] -create [commands]   Create hex-encoded gthpcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gthpcoin transaction
