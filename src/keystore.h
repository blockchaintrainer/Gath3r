...
#ifndef GTHPCOIN_KEYSTORE_H
#define GTHPCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/gthpcoin/bips/blob/master/bip-0013.mediawiki
