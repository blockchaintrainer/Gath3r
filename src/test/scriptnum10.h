...
#ifndef GTHPCOIN_TEST_SCRIPTNUM10_H
#define GTHPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gthpcoin Core 0.10.0, for cross-comparison.
 */
public:
