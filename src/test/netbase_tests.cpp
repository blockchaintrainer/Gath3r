// Copyright (c) 2012-2019 The Gthpcoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.gthpcoincore.org", "www.gthpcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.gthpcoincore.org]", "www.gthpcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.gthpcoincore.org:80", "www.gthpcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gthpcoincore.org]:80", "www.gthpcoincore.org", 80));
