...
#ifndef GTHPCOIN_WALLET_WALLET_H
#define GTHPCOIN_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! gthpcoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Gthpcoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this gthpcoin node, and set to 0 for transactions that were created
...
#endif // GTHPCOIN_WALLET_WALLET_H
