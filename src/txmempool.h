...
#ifndef GTHPCOIN_TXMEMPOOL_H
#define GTHPCOIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/gthpcoin/gthpcoin/pull/14193 will fix it. No known code
     * in gthpcoin currently depends on second guarantee, but it is important to
