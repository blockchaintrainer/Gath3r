...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the gthpcoin repository."
  exit 1
fi
...
# See https://github.com/gthpcoin/gthpcoin/issues/16064
...
echo
echo 'When compiling gthpcoind, run `./configure` in the following way:'
echo
