...
This document provides guidelines for internationalization of the Gthpcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gthpcoin_en.ts` remains unchanged.
