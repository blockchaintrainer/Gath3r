Gthpcoin Core version 0.16.3 is now available from:

  <https://gthpcoincore.org/bin/gthpcoin-core-0.16.3/>
...
been discovered in Gthpcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` gthpcoinconsensus: invalid flags error should be set to `gthpcoinconsensus_err` (afk11)
