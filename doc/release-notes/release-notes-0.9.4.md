Gthpcoin Core version 0.9.4 is now available from:

  https://gthpcoin.org/bin/0.9.4/
...
this update is incompatible with the Gthpcoin system and could lead to consensus
forks.

Gthpcoin Core released binaries from https://gthpcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gthpcoin/+archive/ubuntu/gthpcoin
- A third-party or self-compiled Gthpcoin Core

upgrade to Gthpcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
