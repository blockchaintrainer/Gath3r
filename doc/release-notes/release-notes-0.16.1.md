Gthpcoin Core version 0.16.1 is now available from:

  <https://gthpcoincore.org/bin/gthpcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting gthpcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure gthpcoind processes are cleaned up when tests end (sdaftuar)
