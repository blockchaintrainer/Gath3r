Gthpcoin Core version *0.15.2* is now available from:

  <https://gthpcoincore.org/bin/gthpcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in gthpcoin-tx (TheBlueMatt)
