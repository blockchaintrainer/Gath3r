Gthpcoin Core version 0.13.2 is now available from:

  <https://gthpcoin.org/bin/gthpcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update gthpcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gthpcoin-tx to create v2 transactions (btcdrak)
