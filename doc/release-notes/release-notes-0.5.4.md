Gthpcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gthpcoin/files/Gthpcoin/gthpcoin-0.5.4/
...
http://gitorious.org/gthpcoin/gthpcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gthpcoin-Qt notifications under Growl 1.3.
Increase required age of Gthpcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGthpcoin properly when installing Gthpcoin-Qt over it. (Windows)
