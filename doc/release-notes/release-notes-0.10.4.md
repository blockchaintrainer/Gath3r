Gthpcoin Core version 0.10.4 is now available from:

  <https://gthpcoin.org/bin/gthpcoin-core-0.10.4/>
...
- #6953 `43c2789` Split gthpcoin-tx into its own package
- #6953 `dfe0d4d` Include gthpcoin-tx binary on Debian/Ubuntu
