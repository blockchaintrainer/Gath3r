Gthpcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gthpcoin/files/Gthpcoin/gthpcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gthpcoin
...
New/changed settings (command-line or gthpcoin.conf file)
--------------------------------------------------------
