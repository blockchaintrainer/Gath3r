...
// gthpcoin includes.
#include <..\src\script\gthpcoinconsensus.h>
...
int main()
{
    std::cout << "gthpcoinconsensus version: " << gthpcoinconsensus_version() << std::endl;
    ...
    auto op0Result = gthpcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, gthpcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
